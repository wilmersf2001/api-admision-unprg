...
class UpdateDistributionVacanciesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'vacantes' => 'sometimes|required|integer',
            'programa_academico_id' => 'sometimes|required|integer|exists:tb_programa_academico,id',
            'modalidad_id' => 'sometimes|required|integer|exists:tb_modalidad,id',
