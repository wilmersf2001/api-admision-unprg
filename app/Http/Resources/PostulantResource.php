...
class PostulantResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'departamento_nac_id' => $this->districtBirth?->province?->departamento_id,
            'provincia_nac_id' => $this->districtBirth?->provincia_id,
            'distrito_nac_id' => $this->distrito_nac_id,
            'distrito_nac_name' => $this->districtBirth?->nombre,
            'departamento_res_id' => $this->districtResidence?->province?->departamento_id,
            'provincia_res_id' => $this->districtResidence?->provincia_id,
            ...
            'departamento_col_id' => $this->school?->district?->province?->departamento_id,
            'provincia_col_id' => $this->school?->district?->provincia_id,
            'distrito_col_id' => $this->school?->distrito_id,
